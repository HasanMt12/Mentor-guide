...
const Footer2 = () => {
        ...
        <div className = 'bg-[#0D0D0D] lg:p-20 md:p-10 px-5 pt-5 -mt-8' >
           ...
           <div className='grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2  px-4 '>
            <div className=''>
                 ...
                 Connecting you with expert mentors to help you grow your skills and achieve your goals.
                 </h2> 
          ...
          <AiOutlineTwitter className='text-[#334F5D] text-sm'></AiOutlineTwitter>
               ...
               <div className='px-6 lg:mt-0 mt-4'>
                  ...
                  <div className='flex justify-start gap-2 items-start'>
                    ...
                    <h2 className='text-sm text-gray-300 cursor-pointer'>39 Azimpur, Dhaka - 1205,
                    Dhaka, Bangladesh</h2>
                  </div> 

                  <div className='flex justify-start gap-2  items-start my-2'>
                      <MdCall className='text-white font-semibold'></MdCall>
                    <h2 className='text-sm text-gray-300  cursor-pointer'> +8801602848424</h2>
                    </div> 

                    <div className='flex justify-start gap-2  items-start'>
                      <MdCall className='text-white font-semibold'></MdCall>
                    <h2 className='text-sm text-gray-300  cursor-pointer'>hasan.2mahmud225@gmail.com</h2>
                    </div> 
                </div>
  ...
  <h2 className=' text-white text-sm mt-10 -mb-16'>Copyright © 2023 Mentors Guide . All rights reserved.</h2>
