    ...
    return (
        <div>
           <div className='w-full h-[120px] bg-[#6e0a23] px-20 pt-2' >
                <h2 className='text-md text-gray-200 font-semibold '>Home / Mentors Profile </h2>
                ...
                <div className='flex justify-between items-start px-4'>
                    ...
                    <div className='flex justify-start items-start gap-4 w-[100%]'>
                        ...
                        <div className=''>
                            ...
                            <h2 className='text-gray-400 text-md font-semibold'>{data.desTitle}</h2>
                             <div className='flex justify-start items-center gap-2 mt-6'>
                            <div className='flex justify-start items-center'>
                                <AiFillStar className='text-teal-500'></AiFillStar> <AiFillStar className='text-teal-500'></AiFillStar> <AiFillStar className='text-teal-500'></AiFillStar> <AiFillStar className='text-teal-500'></AiFillStar> <AiFillStar className='text-teal-500'></AiFillStar>
                            </div>
                            <h2>(25)</h2>
                        </div>
                          <div className='flex justify-start items-center mr-2 font-semibold text-slate-700'><GoLocation></GoLocation> <h2 className='ml-4'>{data.location}</h2></div>
                        </div>
                    ...
                    <div className='w-[30%]'>
                        ...
                        <div className='flex justify-start items-center mr-2 font-semibold text-slate-700'><BiLike></BiLike> <h2 className='ml-4'>40%</h2></div>
                         <div className='flex justify-start items-center mr-2 font-semibold my-1 text-slate-700'><FiMessageSquare></FiMessageSquare> <h2 className='ml-4'>35 Feedback</h2></div>
                         <div className='flex justify-start items-center mr-2 font-semibold text-slate-700'><GoLocation></GoLocation> <h2 className='ml-4'>{data.location}</h2></div>
                        ...
                        <button className='bg-teal-500 px-4 py-1 rounded-lg text-xl font-semibold transition hover:-translate-y-1 hover:scale-105 duration-700 ease-in-out shadow-lg text-white'>Book Now</button>
                    </div>  
