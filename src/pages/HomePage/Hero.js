...
const Hero =() =>{
    ...
    return(
        <div className = 'bg-cover z-0' >
            ...
            <div>
                <h2 className='text-center lg:text-4xl md:text-2xl text-xl font-bold text-[#650006] mt-20'>Search Mentor, Make an Appointment</h2>
        ...
        <label class="relative block">
            ...
            <input
                ...
                placeholder="Based on your Location" type="text" />
        </label>
    </form>
        ...
        <label class="relative block">
            ...
            <input
                ...
                placeholder="Search Mentors" type="text" />
        </label>
    </form>
