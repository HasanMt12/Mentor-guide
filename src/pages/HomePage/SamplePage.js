        ...
        <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            ...
            <h2 className= "mb-5 font-sans text-lg font-semibold tracking-tight text-slate-700 sm:text-2xl sm:leading-none" >
             ...
             <button className='bg-transparent transition hover:-translate-y-1 hover:scale-105 duration-700 ease-in-out shadow-lg border-[2px] border-[#d63131] rounded-lg px-2 py-1 text-slate-600 hover:bg-teal-50 hover:text-[#98242C] font-bold'><Link to='/' >Back to home</Link></button>
