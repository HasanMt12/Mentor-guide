...
//REACT_APP_imgbb_key=d5757c0def6c06cb18a0d7ebbaa38017
    // get date 
    const date = new Date()
    ...
    fetch(url, {
      ...
      .then((imgData) => {
        if (imgData.success) {
          ...
          fetch("https://product-sell-server.vercel.app/blog", {
            method: "POST",
            headers: {
          ...
          <div className="grid grid-cols-6 gap-4 col-span-full  lg:col-span-3">
           ...
           <div className="col-span-full sm:col-span-3">
              ...
              <select
                ...
                className="select pl-4 select-bordered py-1 border-2 border-teal-600  focus:ring-opacity-75 focus:ring-violet-400   text-teal-800 w-full rounded-md "
              >
